...
namespace Polymorphism
{
    public class Rectangle : Shape
    {
        ...
        {
            Console.WriteLine($"{"", -25}{this.Id, -3} | {"Hinh Chu Nhat", -15} | {this.p1.ThongTin(), -8} | {this.p2.ThongTin(), -8} | {this.color, -7} | {Math.Round(this.ChuVi(), 2), -6} | {Math.Round(this.DienTich(),2), -9}");
        }
